# -*- coding: utf-8 -*-
## @package ivf.core.sparse_smoothing.bilateral_smoothing
#
#  ivf.core.sparse_smoothing.bilateral_smoothing utility package.
#  @author      tody
#  @date        2016/02/03
...
def bilateralSmoothing(image):
    ...
    Labxy_sparse = shuffle(Labxy, random_state=0)[:100]
